...
const cli = () => {
    ...
    if (validateCommand(command).v) {
        ...
        console.log (`${command} is not a valid Helix command. Please reference the commands list by 'Helix help' to see a full list of commands and aliases`.toUpperCase().red)
    }
}
